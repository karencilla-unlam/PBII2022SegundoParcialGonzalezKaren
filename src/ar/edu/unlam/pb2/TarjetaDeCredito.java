...
public class TarjetaDeCredito implements Pagadora {
	...
	//Constructor
	public TarjetaDeDebito(Long numeroTarjeta, String nombreTitular, Integer codigoSeguridad, String fechaVencimiento, Double limiteCompraPesos, Double limiteCompraDolares) {
